...
<html>
  ...
  <body ng-app="app" ng-controller="mainCtrl" id="app">
    ...
    <div id="nav">
      ...
      <ul id="navSocials">
        <li><a href="https://www.facebook.com/hejjeghedderrasmusgydeandersenogjegerlidtgladidag/" target="_blank"><i class="fab fa-facebook-square"></i></a></li>
        <li><a href="https://www.linkedin.com/in/rasmus-andersen-0a050211a/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
        <li><a href="https://github.com/mito121" target="_blank"><i class="fab fa-github-square"></i></a></li>
      </ul>
        ...
        <div class="entry">
          <div class="flex">
            <div id="entry-primary">
              <span>H</span><span>e</span><span>l</span><span>l</span><span>o</span><span>,</span> <span>I</span><span>'</span><span>m</span> <span>R</span><span>a</span><span>s</span><span>m</span><span>u</span><span>s</span>
            </div>
          </div>

          <span id="entry-secondary">
            <span>F</span><span>r</span><span>o</span><span>n</span><span>t</span><span>-</span><span>e</span><span>n</span><span>d</span><span>, </span><span>B</span><span>a</span><span>c</span><span>k</span><span>-</span><span>e</span><span>n</span><span>d</span><span>, </span><span>U</span><span>I</span><span>/</span><span>U</span><span>X</span><span>, </span><span>W</span><span>o</span><span>r</span><span>d</span><span>P</span><span>r</span><span>e</span><span>s</span><span>s</span>
          </span>
        </div>
          ...
          <div class="page">
            <div class="grid">
              ...
              <div class="grid-item" ng-repeat="item in boxes">
                <box class="box" item="item" on-select="selectBox" ng-class="{'selected': selected[0].item.name == item.name}">
                  <div class="overlay">
        ...
        <div class="contactFormWrapper">
          ...
          <form ng-submit="contact_me(name, email, msg)" autocomplete="off">
            <div class="contactInput">
              ...
              <input type="text" required autocomplete="off" placeholder="Enter your name" name="name" ng-model="name" id="contactName">
            </div>

            <div class="contactInput">
              <label for="contactEmail">Email</label>
              <input type="email" autocomplete="off" required placeholder="Enter your email" name="email" ng-model="email" id="contactEmail">
            </div>

            <div class="contactInput">
              <label for="contactMsg">Message</label>
              <textarea placeholder="Enter your message..." name="msg" required autocomplete="off" id="contactMsg" ng-model="msg" rows="4" cols="50"></textarea>
            </div>
