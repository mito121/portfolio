...
$section.waypoint(
  function (direction) {
    ...
    if ($currentSection === 4) {
      ...
      $("#sectionCtrls .nextSection a").append(
        '<span class="arrow primary-first-arrow next" id="toTheTopArrow" style="left:11px;"></span>'
      );
      $("#sectionCtrls .nextSection a span:first-child").css("left", "21px");
      $("#sectionCtrls .nextSection a span:nth-child(2)").css(
        "animation-delay",
        ".175s"
      );
...
// json data
const url = "./assets/json/skills.json";
...
d3.json(url, (error, data) => {
  ...
  const link = svg
    ...
    .data(links)
    .enter()
    .append("line") // line to connect nodes
  ...
  simulation.nodes(nodes).on("tick", () => {
    ...
    nodeWrapper.attr(
      ...
      (d) =>
        "translate(" +
        getNodeXCoordinate(d.x) +
        "," +
        getNodeYCoordinate(d.y) +
        ")"
    );
  ...
  simulation.force("link").links(links).distance(45);
});
...
app.controller("mainCtrl", function ($scope, $http) {
  ...
  $scope.boxes = [
    ...
    },
    {
      ...
      myRole:
        "This is a solo project and is built using Nuxt in the frontend, with a Node/Express API for serving data. Nuxt is a static site generator for the frontend framework Vue. This tool lets you build fast and smooth progressive webapplications, while maintaining uncompromised SEO - even though the website is built entirely in JavaScript. Source code for this project is public on my GitLab.",
    ...
    },
    {
      ...
      desc: "This website is a tool for finding, selling, renting or buying apartments, houses or rooms. It is a yet unfinished project that I have been working on by myself in my sparetime. The purpose of this project was to get a better understanding of AJAX-frameworks, as well as to showcase my frontend skills when the project is finished.",
      myRole: "",
      link: "https://boligportal.webnation.dk/",
    },
    {
      name: "Portfolio",
      image: "assets/img/logo.svg",
      role: "Design, AJAX, frontend, backend",
      heading: "My portfolio (your current destination)",
      desc: "Developing this portfolio has been a great experience. It has been fun testing my CSS and JS animation/graphic skills, while playing around in a bunch of different JavaScript libraries that I don't often use; this being d3.js, d3-force, particles.js and angularjs-animate. This site is a further development of my previous portfolio, that was built for my multimediadesign exam in the first semester.",
      myRole: "",
      link: "https://webnation.dk/portfolio/",
    },
  ];
  ...
  $scope.contact_me = function (name, email, message) {
    $http
      ...
      .success(function (response) {
        ...
        if (response > 0) {
          $scope.response =
            "Your email has been sent successfully, and I will get back to you as soon as possible!";
